...
public record JoinFactionResultS2C(Result result, @Nullable Faction faction) {
    ...
    public static JoinFactionResultS2C read(Input input) {
        return new JoinFactionResultS2C(Result.values()[input.readInt()], PacketUtils.readFaction(input));
    }
}
