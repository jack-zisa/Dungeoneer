...
public record ArmorItem(String id, EquipmentType equipmentType, StatContainer statBonus) implements EquipmentItem {
    ...
    public Identifiable withId(String id) {
        return new ArmorItem(id, equipmentType, statBonus);
    }
}
